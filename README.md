...
```
npm create cloudflare@latest -- --template=cloudflare/templates/proud-art-4a53
```

A live public deployment of this template is available at [https://proud-art-4a53.templates.workers.dev](https://proud-art-4a53.templates.workers.dev)
